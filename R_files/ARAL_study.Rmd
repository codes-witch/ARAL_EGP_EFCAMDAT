...
a0a1_normalized <- get_feats_normalized_students(a0a1_feat_counts, a0a1_word_counts)
a1a2_normalized <- get_feats_normalized_students(a1a2_feat_counts, a1a2_word_counts)
a2b1_normalized <- get_feats_normalized_students(a2b1_feat_counts, a2b1_word_counts)
b1b2_normalized <- get_feats_normalized_students(b1b2_feat_counts, b1b2_word_counts)
b2c1_normalized <- get_feats_normalized_students(b2c1_feat_counts, b2c1_word_counts)
c1c2_normalized <- get_feats_normalized_students(c1c2_feat_counts, c1c2_word_counts)
```
